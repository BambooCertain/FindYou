// pages/createTaskAn/createTaskAn.js
var app = getApp();
var that;
Page({
...
taskSubmit:function(e){
    ...
    wx.cloud.callFunction({
      ...
      success: res=>{
        console.log('[云函数][createFindTask][创建寻宠任务]调用成功' , res)
        // console.log('this.data.detailPics[0].substring(11)' , this.data.detailPics[0].substring(11))
      },
      fail: res=>{
        console.log('[云函数][createFindTask][创建寻宠任务]调用失败' , res)
      }
    })
